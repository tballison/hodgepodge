...
public class SparseFixedBitSet {
  ...
  private static final int NO_MORE_DOCS = -1;
  ...
  private void or(final int i4096, final long index, long[] bits, int nonZeroLongCount) {
    ...
    if (currentIndex == 0) {
      ...
      indices[i4096] = index;
      this.bits[i4096] = copyOfSubArray(bits, 0, nonZeroLongCount);
  ...
  public String toString() {
    return "org.apache.lucene.SparseFixedBitSet(size=" + length + ",cardinality=~" + cardinality();
  }
